...
const DefaultLayout = ({ background, children, contentClass }) => {
  ...
  const styleBackground = background ? { backgroundImage: "url('/bg.svg')" } : null;
  return (
    <div>
      <div className="text-gray-900">
        <div className="h-screen bg-cover bg-right" style={styleBackground}>
          <Header />
          <div className={`container px-10 mx-auto flex flex-wrap flex-col md:flex-row items-center ${contentClass}`}>
            {children}
